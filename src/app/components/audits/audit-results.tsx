...
export function AuditResults() {
  ...
  // For now, use all platforms from MOCK_AUDIT since we don't have stored profiles
  const [platforms, setPlatforms] = useState(() => {
    return MOCK_AUDIT.platforms.map((p, i) => ({ ...p, enabled: i === 0 }))
  })
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="flex items-start justify-between mb-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => navigate(`/audits/${auditId}/action-hub`)} className="flex items-center gap-2 px-4 py-2 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg text-sm font-medium transition-all">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => navigate(`/audits/${auditId}/action-hub`)} className="flex items-center gap-2 px-5 py-2.5 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg text-sm font-medium transition-all">
